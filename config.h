...
static const char *fonts[]          = { "Caskaydia Cove Nerd Font:size=10", "monospace:size=11" };
...
static const char *eDP1_off[]   = { "/home/ak/scripts/toggle-screen.sh", "off", NULL };
static const char *eDP1_on[]   = { "/home/ak/scripts/toggle-screen.sh", "on", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_c,      quit,           {1} }, // Reload (patch)
    ...
    /* vanity gaps patch */
	{ MODKEY|Mod1Mask,              XK_h,      incrgaps,       {.i = +2 } },
	{ MODKEY|Mod1Mask,              XK_l,      incrgaps,       {.i = -2 } },
	// { MODKEY|Mod1Mask|ShiftMask,    XK_h,      incrogaps,      {.i = +2 } },
	// { MODKEY|Mod1Mask|ShiftMask,    XK_l,      incrogaps,      {.i = -2 } },
	// { MODKEY|Mod1Mask|ControlMask,  XK_h,      incrigaps,      {.i = +2 } },
	...
	{ MODKEY|Mod1Mask,              XK_y,      incrohgaps,     {.i = +2 } },
	{ MODKEY|Mod1Mask,              XK_o,      incrohgaps,     {.i = -2 } },
	{ MODKEY|ShiftMask,             XK_y,      incrovgaps,     {.i = +2 } },
	{ MODKEY|ShiftMask,             XK_o,      incrovgaps,     {.i = -2 } },
	{ MODKEY|ShiftMask|ControlMask, XK_1,      spawn,          {.v = eDP1_off } },
	{ MODKEY|ControlMask,           XK_1,      spawn,          {.v = eDP1_on } },
};
